    ...
    <section id="solution" className="py-20" style={{ backgroundColor: '#141414' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left Content */}
          <div>
            <h2 id="approach" className="text-4xl md:text-5xl font-bold mb-8 leading-tight text-white pt-40" style={{ marginTop: '-13rem' }}>
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-xl" style={{ backgroundColor: '#FFFEEB' }}>
            ...
            <div className="p-6 rounded-xl" style={{ backgroundColor: '#C1F21D' }}>
              <div className="text-3xl mb-4">📊</div>
              <h3 className="text-xl font-bold mb-3" style={{ color: '#141414' }}>
                Data Analytics
              </h3>
